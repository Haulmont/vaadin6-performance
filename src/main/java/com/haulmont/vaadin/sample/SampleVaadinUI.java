 ...
 * @version $Id$
 */
public class SampleVaadinUI extends Application {
    ...
    protected void repaint() {
        try {
            n = Integer.parseInt((String) text1.getValue());
        } catch (NumberFormatException e) {
            n = 10;
        }

        try {
            r = Integer.parseInt((String) text2.getValue());
        } catch (NumberFormatException e) {
            r = 10;
        }

        try {
            c = Integer.parseInt((String) text3.getValue());
        } catch (NumberFormatException e) {
            c = 10;
        }
